...
- Generate DETAILED, in-depth, and exam-focused  notes.
- Keep the same structure strictly.
- Do not add extra sections like advantages, applications, history, diagrams, or charts.
- Diagrams and charts are handled by a separate prompt.
- Focus on deep conceptual clarity.

For EACH topic, strictly include:

Definition
- Clear, standard textbook-level definition.
- Precise and exam-oriented.
- 2–3 lines maximum.
...
- Important rules, conditions, or properties.
- 3–4 lines maximum per paragraph.
- Multiple small paragraphs allowed for depth.

Examples (if applicable)
- Concept-based example.
- Stepwise explanation.
- If numerical/programming, show step breakdown.
- Keep explanation concise but clear.

Formatting Rules:
- Paragraph length: maximum 2–4 lines.
- No storytelling.
- No motivational language.
- No unnecessary background theory.
- No diagrams, no charts.
- No emojis.
- Academic and professional tone.
- Avoid repetition.
- Content must be exam-focused and conceptually strong.
